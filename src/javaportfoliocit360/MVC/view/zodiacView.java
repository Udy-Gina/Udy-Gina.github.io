...
import javaportfoliocit360.JavaPortfolioCIT360;
...
This is the VIEW...it should be the welcome page with a system.in function to accept a month and date

It should then call the if/else function in the CONTROLLER for determining which sign a person is

The CONTROLLER should return the appropriate horoscope to be displayed in the VIEW 
